...
for (const element of simpsons) {
    ...
    divSurname.innerText = element.surname
    let divAge = document.createElement('div');
    divAge.innerText = element.age;

    let pInfo = document.createElement('p');
    pInfo.innerText = element.info;
...
for (const item of coursesArray) {
    ...
    monthDurationElement.innerText = item.monthDuration;
    let hourDurationElement = document.createElement('div');
    hourDurationElement.innerText = item.hourDuration;
